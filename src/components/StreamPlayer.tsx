        ...
        <AspectRatio ratio={16 / 9}>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-white text-center">
              ...
              <p className="text-xl">Stream failed to load</p>
      ...
      <AspectRatio ratio={16 / 9} className="w-full">
        {!isContentLoaded && (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-[#151922]">
            <div className="text-white text-center">
              <Loader className="h-12 w-12 animate-spin mx-auto mb-4 text-[#ff5a36]" />
              <p className="text-xl">Loading {stream.language} stream...</p>
        ...
        <iframe 
          key={`${stream.id}-${stream.embedUrl}`}
          ref={videoRef}
          src={stream.embedUrl}
          className="w-full h-full absolute inset-0"
          allowFullScreen
          title={`Live Stream - ${stream.language}`}
