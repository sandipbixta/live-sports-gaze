...
const ChannelsGrid = () => {
  ...
  const handleSelectChannel = (channel: any, country: string) => {
    navigate(`/channel/${channel.countryCode || country}/${channel.id}`);
  };
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
            {filteredChannels.map(channel => (
              <div
                ...
                className="bg-card rounded-xl p-3 cursor-pointer hover:bg-accent transition-all duration-200 border border-border hover:border-sports-primary group relative"
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  {/* Channel Logo */}
                  <div className="w-14 h-14 rounded-xl mb-2 overflow-hidden flex items-center justify-center bg-white p-1.5 group-hover:scale-105 transition-transform shadow-sm">
                    {channel.logo ? (
                      <>
                        <img
                          src={channel.logo}
                  ...
                  {/* Channel Name */}
                  <h3 className="text-xs font-medium text-foreground group-hover:text-sports-primary transition-colors line-clamp-2 leading-tight">
                    {channel.title}
                  </h3>
