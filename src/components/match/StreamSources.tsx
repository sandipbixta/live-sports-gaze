    ...
    <div className="mt-6">
      ...
      <div className="space-y-2">
        {Object.entries(effectiveStreams).map(([sourceKey, streams]) => {
          ...
          return (
            <div key={sourceKey} className="border border-yellow-600/40 rounded-lg p-2.5 bg-black/40">
              {/* Source header */}
              <div className="flex items-start justify-between mb-2">
                <div>
                  <h4 className="text-white text-lg font-bold mb-0.5">{sourceName}</h4>
                ...
                <span className="text-[#ff5722] text-xs font-medium">{streamCount} streams</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {/* Viewer count */}
                        {viewerCount > 0 && (
                          <span className="text-[#ff5722] text-xs flex items-center gap-1">
                            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
